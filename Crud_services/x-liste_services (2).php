...
<body class="container py-4">
    ...
    <a href="../pages/admin_dashboard.php" class="btn btn-secondary">⬅ Retour</a>
    <a href="../Crud_services/ajouter_service.php" class="btn btn-success">Ajouter un nouvel Habitat</a>
    </div>
            ...
            <tbody>
                <?php foreach ($habitats as $habitat): ?>
                    <tr>
                        ...
                        <td class="action">
                            <a  href="modifier_service.php?id=<?= $habitat['id'] ?>" class="btn btn-warning btn-sm">Modifier</a>
                            <a  href="supprimer_service.php?id=<?= $habitat['id'] ?>" onclick="return confirm('Supprimer ce service ?')" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                        <!--</section>-->
                    </tr>
                <?php endforeach; ?>
