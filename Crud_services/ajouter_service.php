...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO services (nom, images, description) VALUES (?, ?, ?)");
...
<div class="container">
        <h2><i class="fas fa-home"></i> Ajouter un Service</h2>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn"><i class="fas fa-plus-circle"></i> Ajouter Service</button>
        </form>
    </div>
