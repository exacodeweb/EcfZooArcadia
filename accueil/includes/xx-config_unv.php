...
if (DEBUG_MODE) {
    ...
    ini_set('error_log', __DIR__ . '/../logs/error.log'); // Chemin vers le fichier de logs
} else {
    error_reporting(0);
    ini_set('display_errors', '0');
    ini_set('log_errors', '1');
    ini_set('error_log', __DIR__ . '/../logs/error.log'); // Toujours loguer les erreurs en mode prod
}
