    ...
    <aside class="aside col-md-4"> <!-- col-md-4 -->
      ...
      <div class="col-md-12"><!-- col-lg-6  -->
        <div class="card shadow">
          <div class="card-body text-center">
            <h5 class="card-title">Sécurité du compte</h5>
            <a href="../password/get_mdp.php" class="btn btn-warning w-100 mb-3">Modifier Mot de Passe employé</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body text-center">
            <h5 class="card-title">Gestion des Services</h5>
            <a href="../Crud_services/liste_services.php" class="btn btn-secondary">Liste des Services</a>
          </div>
        </div>
      </div>

      <!--<a href="../Crud_specification/form-ajout.php" class="btn btn-secondary">Liste des Services</a>-->
      <a href="../Crud_specification/ajouter.php" class="btn btn-secondary">Liste des Services</a>

      <a href="../Crud_specification/manage-specifications.php" class="btn btn-secondary">Liste des Services</a>
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body text-center">
            <h5 class="card-title">Gestion des Animaux</h5>
            <a href="../manage_animaux/index.php" class="btn btn-secondary">Liste des Animaux</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body text-center">
            <!--<h5 class="card-title">Gestion des Animaux</h5>-->
            <a href="../service_veterinaire/comptes_rendus.php" class="btn btn-secondary">Comptes-rendus</a>
          </div>
        </div>
      </div>

      <a href="../crud_services/ajouter_service.php">Ajouter un service</a>
      <!--</section>-->
    </aside>
  </div>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Accédez aux différentes fonctionnalités de gestion.</p>
                    </div>
                </div>
            </div>
...
<body>
  ...
  <div class="container col-mt-12 col-md-12"><!--  -->
    ...
    <aside class="aside col-md-4"> <!-- col-md-4 -->
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body text-center">
            <h5 class="card-title">Gestion des avis</h5>-->
      <!--<a href="../avis_system_test/moderation-avis.php" class="btn btn-primary">Modérer les Témoignages</a>--><!--
                  <a href="../service_employe/liste_consommation.php" class="btn btn-secondary">liste consommation</a>
          </div>
        </div>
      </div>-->
      ...
      <!--<a href="../Crud_habitats/index.php">Liste des Habitats</a>-->
...
<body>
  <div class="container my-4">
    ...
    <div class="row dashboard-grid">
      <!-- Sécurité du compte (Modifier mot de passe) -->

      <a href="modifier-mot-de-passe.php" class="btn btn-warning">Modifier mon mot de passe</a>

      <!-- Sécurité du compte employé -->

      <a href="../password/get_mdp.php" class="btn btn-warning">Modifier Mot de Passe employé</a>
      ...
      <!-- Spécifications (Ajouter & Gérer) -->

      <a href="../Crud_specification/ajouter.php" class="btn btn-secondary mb-2">Ajouter spécification</a>
      <a href="../Crud_specification/manage-specifications.php" class="btn btn-secondary">Gérer spécifications</a>
      ...
      <a href="../service_veterinaire/comptes_rendus.php" class="btn btn-secondary">Voir Comptes-rendus</a>

      <!-- Ajouter un service -->

      <a href="../crud_services/ajouter_service.php" class="btn btn-outline-primary">Ajouter un service</a>
    </div>
  </div>
